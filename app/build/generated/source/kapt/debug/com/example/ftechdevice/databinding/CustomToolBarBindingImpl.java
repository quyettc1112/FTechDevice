...
import com.example.ftechdevice.BR;
...
public class CustomToolBarBindingImpl extends CustomToolBarBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.llStartIcon, 2);
        sViewsWithIds.put(R.id.ivStartIcon, 3);
        sViewsWithIds.put(R.id.tvStartText, 4);
        sViewsWithIds.put(R.id.tvTitle, 5);
        sViewsWithIds.put(R.id.llEndIcon, 6);
        sViewsWithIds.put(R.id.ivEndIcon, 7);
        sViewsWithIds.put(R.id.toolBarShadow, 8);
    }
    // views
    @NonNull
