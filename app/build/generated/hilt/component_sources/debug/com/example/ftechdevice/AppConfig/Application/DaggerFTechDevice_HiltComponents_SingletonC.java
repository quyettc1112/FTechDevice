...
public final class DaggerFTechDevice_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends FTechDevice_HiltComponents.ActivityC {
    ...
    private void initialize(final Activity activityParam) {
      ...
      this.youtubeAPI_RepositoryProvider = DoubleCheck.provider(new SwitchingProvider<YoutubeAPI_Repository>(singletonCImpl, activityRetainedCImpl, activityCImpl, 3));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 3: // com.example.ftechdevice.API_Repository.YoutubeAPI_Repository 
  ...
  private static final class SingletonCImpl extends FTechDevice_HiltComponents.SingletonC {
    ...
    private void initialize() {
      ...
      this.provideProductAPIProvider = DoubleCheck.provider(new SwitchingProvider<ProductAPI_Service>(singletonCImpl, 5));
      this.provideYoutubeBaseUrlProvider = DoubleCheck.provider(new SwitchingProvider<String>(singletonCImpl, 7));
      this.provideYoutubeAPIProvider = DoubleCheck.provider(new SwitchingProvider<YoutubeAPI_Service>(singletonCImpl, 6));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 5: // com.example.ftechdevice.API_Service.ProductAPI_Service 
          ...
          case 6: // com.example.ftechdevice.API_Service.YoutubeAPI_Service 
          ...
          case 7: // @javax.inject.Named("youtube") java.lang.String 
